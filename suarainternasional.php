<?php
$berita_json = file_get_contents('beritainternasional.json');
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a class="tanda" href="suarainternasional.php">Suara Internasional</a></li>
                <li><a href="suarateknologi.php">Suara Teknologi</a></li>
